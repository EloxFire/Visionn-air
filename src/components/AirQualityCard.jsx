...
export default function AirQualityCard({ loading, error, iqa, main_polluent_name }) {
  ...
  return (
    <View style={[airQualityCardStyle.card, loading && { alignItems: 'center', justifyContent: 'center' }]}>
      {
